...
if __name__=="__main__":
    ...
    np.save(f'/home/kurmukov/aver_200_level1_{sparsity}.npy',
           partition_level_1)
    np.save(f'/home/kurmukov/aver_200_level2_{sparsity}.npy',
           partition_level_2)
    np.save(f'/home/kurmukov/aver_200_level3_{sparsity}.npy',
           partition_level_3)
